...
create_layout(){
  ...
  rsync -a --delete --exclude ".git" --exclude ".github"     "${REPO_DIR}/vps-app" "${REPO_DIR}/vps-db" "${REPO_DIR}/vps-infra" "${REPO_DIR}/vps-monitoring" "${REPO_DIR}/vps-security" "${REPO_DIR}/plugins" "${REPO_DIR}/docs" "${REPO_DIR}/config" "${REPO_DIR}/vps-secrets" "${REPO_DIR}/vps-alerting" "${REPO_DIR}/vps-platform" "${VPS_ROOT}/"
